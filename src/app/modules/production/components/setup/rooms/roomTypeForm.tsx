      ...
      <Link to="/roomType">
        ...
        <div className="tab-content">
          ...
          {<div className='col-8'>
            ...
            <div className='row mb-0'>
              <div className='col-6 mb-7'>
              <label htmlFor="exampleFormControlInput1" className="required form-label">Price</label>
              <input type="text"  {...register("price")}  className="form-control form-control-solid" />
              </div>
            </div>
          </div>
          }
