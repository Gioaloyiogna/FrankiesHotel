...
import { Api_Endpoint, fetchRooms,fetchGuests,fetchBookings} from '../../../../../../services/ApiCalls'
...
const Calendar = () => {
  ...
  const {data: bookingsdata, isLoading: bookingsLoad} = useQuery('bookings', fetchBookings)
    ...
    if (args.date) {
        if(args.elementType==="monthCells"){
          ...
          bookingsdata?.data.find((e)=>{
            if(new Date(e['bookStart']).toISOString().split('T')[0]===formattedDate&&e['roomId']===2){
